...
var ColorfulButton = function (_a) {
    ...
    var _f = useState(0), clickCount = _f[0], setClickCount = _f[1];
    var colors = [
    ...
    return (jsx("button", { style: buttonStyle, onClick: handleClick, onMouseEnter: function () { return setIsHovered(true); }, onMouseLeave: function () { return setIsHovered(false); }, className: className, children: children }));
};
